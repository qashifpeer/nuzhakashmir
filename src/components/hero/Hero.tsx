      ...
      <div className="relative w-full h-[100vh]">
        ...
        transition={{ duration: 1, delay: 0.5 }}
         ...
         className="absolute md:p-4  top-0 left-0 right-0 w-full h-full flex flex-col items-center justify-center bg-emerald-800/20 backdrop-brightness-75">
          ...
          <h1 className="text-slate-100 text-center text-lg md:text-3xl font-kalam leading-10 py-2">
          Explore the best places to visit in Kashmir with us, without Breaking the Bank
          </h1>
